...
export class AltaReclamo extends Component {
    ...
    GetData = () => {
        ...
        return fetch('http://192.168.43.90:8080/myapp/Reclamos/Nombres?documento='+ this.state.documento)
    ...
    nuevoReclamo = async () => {
        ...
        const url = 'http://192.168.43.90:8080/myapp/Reclamos/alta?documento=' + documento + '&codigo=' + codigo + '&ubicacion=' + ubicacion + '&descripcion=' + descripcion + '&identificador=' + identificador + '&piso=' + piso + '&nombre=' + nombre;
        fetch(url)
            .then(res =>  res.json()).then((json) => {
                console.log (json)
                if (json == true) {
    ...
    ObtenerIdentificadores(nombre) {
        const url = 'http://192.168.43.90:8080/myapp/Reclamos/ObtenerIdentificadoress?nombre=' +  nombre;
        fetch(url)
    ...
    QueIdReclamo(documento, nombre, descripcion, piso) {
        const url = 'http://192.168.43.90:8080/myapp/Reclamos/Obtener?documento=' +  documento + "&nombre=" + nombre + "&descripcion=" + descripcion + "&piso=" + piso ;
    ...
    IdentificadorDuenio(codigo, documento) {
        var i = 0;
        const url = 'http://192.168.43.90:8080/myapp/Reclamos/Identificad?codigo=' +  codigo + "&documento=" + this.state.documento;
       console.log (url)
    ...
    LimpiarInfo = async () =>{
        ...
        this.mostrarMensaje("Los Datos Han sido Borrados, Se vera reflejado en el proximo uso ")
    }
    render() {

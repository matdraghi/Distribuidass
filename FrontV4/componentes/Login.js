...
import { View, StyleSheet, KeyboardAvoidingView, Text, StatusBar, AsyncStorage, Image, TouchableOpacity } from 'react-native'
...
export class Login extends Component {
   ...
   /* GetData (documento)  {
    ...
    autenticar = () => {
        ...
        const url = 'http://192.168.43.90:8080/myapp/Login?documento=' + documento + '&password=' + password;
        fetch(url)
            .then((res) => res.json()).then((json) => {
                console.log (json)
                if (json === true) {

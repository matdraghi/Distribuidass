...
export class DetallesReclamos extends Component {
    ...
    pisos(codigo, documento) {
        var i = 0;
        const url = 'http://192.168.43.90:8080/myapp/Reclamos/Pisos?codigo=' +  codigo + "&documento=" + this.state.documento;
       console.log (url)
    ...
    cargarReclamo = () => {
        ...
        const url = 'http://192.168.43.90:8080/myapp/Reclamos/altaEdificio?documento=' + documento + '&codigo=' + codigo + '&ubicacion=' + ubicacion + '&descripcion=' + descripcion + "&nombre=" + nombre + "&piso=" + piso;
        //alert (url)
